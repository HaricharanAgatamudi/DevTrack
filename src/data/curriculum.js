...
export const CURRICULUM = [
  ...
  { morning: session('ML - TensorFlow or PyTorch first model', 'ML'), evening: session('Project - CI/CD, README, final deployment polish', 'PROJ') },
  ...
  { morning: session('SQL - e-commerce dataset CTEs and windows', 'SQL'), evening: session('Project - public API and Swagger docs', 'PROJ') },
  ...
  { morning: session('DS - end-to-end case study', 'DS'), evening: session('Project - portfolio polish and live demo', 'PROJ') },
]
...
export const PROJ_MODS = [
  ...
  { id: 'admin', name: '8. Admin Dashboard', time: '5 days', features: ['Users', 'Moderation', 'Analytics', 'Restrictions'] },
  { id: 'api', name: '9. Public API and Docs', time: '3 days', features: ['REST API', 'Swagger docs', 'Rate limits', 'API keys'] },
  { id: 'deploy', name: '10. Deployment and DevOps', time: '2 days', features: ['Vercel', 'Railway', 'MongoDB Atlas', 'GitHub Actions'] },
]
